                ...
                <p>
                    ...
                    if ($is_text && !FM_READONLY) {
                      ...
                      <!--  <b><a href="?p=<?php //  echo urlencode(trim(FM_PATH)) ?>&amp;edit=<?php // echo urlencode($file) ?>" class="edit-file"><i class="fa fa-pencil-square"></i> <?php // echo lng('Edit') ?> -->
                            <b><a href="http://codejudge.sanchozzz.beget.tech/page5<?php //  echo urlencode(trim(FM_PATH)) ?><?php // echo urlencode($file) ?>" target="_blank" class="edit-file"><i class="fa fa-pencil-square"></i> <?php  echo lng('Edit') ?> 
