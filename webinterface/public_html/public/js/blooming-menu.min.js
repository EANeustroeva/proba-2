...
!function () {
    ...
    function e(n) {
        return this instanceof e ? (this.props = {}, t.call(this, n), void (this.state = {isOpen: !1, isBeingAnimated: !1})) : new e(n)
    }

    function t(e) {
        if (e = e || {}, void 0 === e.itemsNum) throw new Error("`opts.itemsNum` must be declared");
        this.props.itemsNum = e.itemsNum, this.props.injectBaseCSS = void 0 === e.injectBaseCSS, this.props.startAngle = void 0 === e.startAngle ? 90 : e.startAngle, this.props.endAngle = void 0 === e.endAngle ? 0 : e.endAngle, this.props.radius = e.radius || 80, this.props.itemAnimationDelay = e.itemAnimationDelay || .04, this.props.animationDuration = e.animationDuration || .4, this.props.fatherElement = e.fatherElement || document.body, this.props.elements = {}, this.props.itemWidth = e.itemWidth || 50, this.props.mainContent = e.mainContent || "+", this.props.CSSClassPrefix = e.CSSClassPrefix || "blooming-menu__"
    }
    ...
    function n(e) {
        ...
        for (var n = 0; n < e.itemsNum; n++) {
            ...
            a.classList.add(t + y), s.appendChild(a), i.appendChild(s), e.elements.itemsContainer.appendChild(i), e.elements.items.push(i)
        }
    ...
    function m() {
        var e, t = document.createElement("fakeelement"), n = {animation: "animationend", webkitAnimation: "webkitAnimationEnd"};
    ...
    var u = "container", f = "main-container", h = "main", b = "main-content", x = "items", w = "item-btn-wrapper", k = "item", y = "item-btn";
    e.prototype.render = function () {
        var e = "";
        return n(this.props), this.props.injectBaseCSS && (e = i(this.props), s(e, this.props.elements.styleSheet)), a(this.props), p(this), this
        ...
        var t = this, n = document.querySelector("." + t.props.CSSClassPrefix + w), i = function () {
        ...
        return n.addEventListener(m(), i), this.props.elements.items.forEach(function (t, n) {
            n !== e ? t.classList.add("is-not-selected") : t.classList.add("is-selected")
